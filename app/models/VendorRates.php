...
class VendorRates extends Eloquent implements UserInterface, RemindableInterface {
	...
	protected $fillable = ['vendor','state','county','personal','runFlat','runBase','runMileage','runRush','runSameDay','serviceFlat','serviceBase','serviceMileage','serviceRush','serviceSameDay','add_servee','postFlat','postBase','postMileage','postRush','postSameDay','free_pgs','pg_rate'];
